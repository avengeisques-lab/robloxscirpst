...
----------------------------------------------------------------
-- BACKEND LOGIC LOOPS (ESP, Noclip, Speed, Aimbot)
----------------------------------------------------------------

-- Manage ESP Drawing creation per player
...
-- Main Heartbeat/RenderStepped loop
...
-- Character specific modifiers (Speed & Noclip handled safely via Stepped loops)
...
-- Clean up drawings when players leave
