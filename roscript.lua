...
-- Rayfield UI Library
local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/linen018/Rayfield/main/source.lua"))()
            ...
            if player.Character and player.Character:FindFirstChild(Config.Aimbot.TargetPart) then
                ...
                if distance < shortestDistance and onScreen then
                    if Config.Aimbot.VisibilityCheck then
                        local ray = Ray.new(Camera.CFrame.Position, (player.Character[Config.Aimbot.TargetPart].Position - Camera.CFrame.Position).Unit * 1000)
...
LocalPlayer.CharacterAdded:Connect(function(character)
    ...
    character.Humanoid.WalkSpeed = Config.Misc.WalkSpeed
    character.Humanoid.JumpPower = Config.Misc.JumpPower
end)
